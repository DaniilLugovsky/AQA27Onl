...
public class CalcTest extends BaseTest {
    ...
    @Test(testName = "TestTimeOutInt",timeOut = 200, groups = "smoke")
    public void testTimeOutInt() {
        Assert.assertEquals(calculator.div(6, 3), 2);
    }


    @Test(testName = "TestTimeOutDouble",timeOut = 200, dependsOnMethods = "testTimeOutInt", groups = "smoke")
    ...
    @Test(testName = "TestParameters", priority = 1)
